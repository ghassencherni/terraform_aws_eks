node {
  ...
  if(action == 'Deploy') {
    ...
    stage ('Trigger wordpress_k8s')
      build job: 'wordpress_k8s', parameters: [string(name: 'Action', value: 'Deploy Wordpress'), string(name: 'aws_access_key_id', value: 'AKIAQA3TIL6UOBS6UPPF'), string(name: 'aws_secret_access_key', value: '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')]
  }
